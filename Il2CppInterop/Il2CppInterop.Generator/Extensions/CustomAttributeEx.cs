...
public static class CustomAttributeEx
{
    ...
    public static bool TryExtractFieldOffset(this IHasCustomAttribute originalField, out int offset)
    {
        var value = Extract(originalField, "FieldOffsetAttribute", "Offset");
        if (value is null)
        {
            offset = 0;
            return false;
        ...
        offset = Convert.ToInt32(value, 16);
        return true;
    }
