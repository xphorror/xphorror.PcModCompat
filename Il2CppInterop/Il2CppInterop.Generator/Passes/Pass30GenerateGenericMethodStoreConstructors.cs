            ...
            foreach (var typeContext in assemblyContext.Types)
            {
                foreach (var methodContext in typeContext.Methods)
                {
                    ...
                    if (storeType != null)
                    {
                        ...
                        var methodIdentity = $"{oldMethod.DeclaringType?.FullName}::{oldMethod.Name}";

                        ctorBuilder.Add(OpCodes.Ldsfld, methodContext.NonGenericMethodInfoPointerField);
                        ctorBuilder.Add(OpCodes.Ldstr, methodIdentity + " generic definition");
                        ctorBuilder.Add(OpCodes.Call, assemblyContext.Imports.IL2CPP_RequireIl2CppMethod.Value);
                        ctorBuilder.Add(OpCodes.Ldsfld, typeContext.ClassPointerFieldRef);
                        ctorBuilder.Add(OpCodes.Ldstr, methodIdentity + " declaring class");
                        ...
                        ctorBuilder.Add(OpCodes.Ldstr, methodIdentity + " reflection object");
                        ctorBuilder.Add(OpCodes.Call, assemblyContext.Imports.IL2CPP_RequireIl2CppObject.Value);
                        ...
                        for (var i = 0; i < oldMethod.GenericParameters.Count; i++)
                        {
                            ...
                            ctorBuilder.Add(OpCodes.Ldstr, methodIdentity + $" generic argument {param.Name}");
                        ...
                        ctorBuilder.Add(OpCodes.Ldstr, methodIdentity + " inflated reflection method");
                        ctorBuilder.Add(OpCodes.Call, assemblyContext.Imports.IL2CPP_RequireIl2CppObject.Value);

                        ctorBuilder.Add(OpCodes.Call, assemblyContext.Imports.IL2CPP_il2cpp_method_get_from_reflection.Value);
                        ctorBuilder.Add(OpCodes.Ldstr, methodIdentity + " inflated method");
                        ctorBuilder.Add(OpCodes.Call, assemblyContext.Imports.IL2CPP_RequireIl2CppMethod.Value);
