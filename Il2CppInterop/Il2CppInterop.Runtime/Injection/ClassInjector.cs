...
public static unsafe partial class ClassInjector
{
    ...
    private static void EnsureClassInjectionEnabled()
    {
        if (!Il2CppInteropRuntime.Instance.ClassInjectionEnabled)
            throw new NotSupportedException("Il2Cpp class injection is disabled by the runtime host.");
    }

    public static void ProcessNewObject(Il2CppObjectBase obj)
    {
        EnsureClassInjectionEnabled();
