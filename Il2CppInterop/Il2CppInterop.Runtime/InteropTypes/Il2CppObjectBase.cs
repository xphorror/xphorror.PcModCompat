...
public class Il2CppObjectBase
{
    ...
    public IntPtr ObjectClass => IL2CPP.RequireIl2CppClass(
    ...
    internal void CreateGCHandle(IntPtr objHdl)
    {
        ...
        myGcHandle = IL2CPP.RequireIl2CppPointer(
            IL2CPP.il2cpp_gchandle_new(objHdl, false),
            "wrapped object GC handle");
    }

    public T Cast<T>() where T : Il2CppObjectBase
    {
        return TryCast<T>() ?? throw new InvalidCastException(
            $"Can't cast object of type {IL2CPP.il2cpp_class_get_name_(ObjectClass)} to type {typeof(T)}");
    }

    internal static unsafe T UnboxUnsafe<T>(IntPtr pointer)
    {
        pointer = IL2CPP.RequireIl2CppObject(pointer, "unbox source object");
        var nestedTypeClassPointer = IL2CPP.RequireIl2CppClass(
            Il2CppClassPointerStore<T>.NativeClassPtr,
            "unbox target class");

        var ownClass = IL2CPP.RequireIl2CppClass(
            IL2CPP.il2cpp_object_get_class(pointer),
            "unbox source class");
        ...
        var data = IL2CPP.RequireIl2CppPointer(
            IL2CPP.il2cpp_object_unbox(pointer),
            "unboxed value data");
    ...
    ~Il2CppObjectBase()
    {
        var handle = myGcHandle;
        myGcHandle = IntPtr.Zero;
